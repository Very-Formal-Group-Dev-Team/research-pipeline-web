...
export const CONCISE_ROLE_GUIDES: Record<DashboardRole, RoleGuideConcise> = {
  student: {
    ...
    label: 'Student',
    overview:
      'Your student account is ready. You can join or create a research project, collaborate with your team, upload and version papers, and track defenses and meetings.',
    keyTasks: [
      ...
      'Respond to notifications about reviews, invitations, and project updates',
    ],
    capabilities: [
      { label: 'Dashboard', description: 'Announcements, invitations, and quick actions' },
      { label: 'My Projects', description: 'View, create, and manage your research projects' },
      { label: 'Notifications', description: 'Alerts for invitations, reviews, and project activity' },
  ...
  adviser: {
    ...
    overview:
      'Your adviser account is ready. You can manage advisee projects, review papers, schedule meetings, and monitor defense schedules for your students.',
    keyTasks: [
      'Review advisee projects and provide feedback on paper versions',
    ...
    capabilities: [
      ...
      { label: 'Notifications', description: 'Review requests, invitations, and schedule alerts' },
...
export const FULL_ROLE_GUIDES: Record<DashboardRole, RoleGuideFull> = {
  student: {
    ...
    overview:
      'Your student account is ready. Archivum is where you manage your research project from first draft through defense. You can create a project and invite teammates, join an existing group with a project code, or accept an invitation from a leader or adviser. Upload papers with version history, request adviser feedback, track meetings and defenses on your schedule, and stay on top of invitations and review updates through notifications.',
    keyTasks: [
      ...
      'Respond to notifications about invitations, join requests, reviews, and schedule changes',
    ...
    capabilities: [
      ...
      },
      {
        label: 'My Projects',
        description:
          'Browse, search, and filter all projects you belong to. Create new projects, accept invitations, and open any project to manage papers, team, and details.',
      },
      {
        label: 'Notifications',
        description:
          'Central inbox for project invitations, join requests, paper review updates, defense and meeting alerts, and other project activity. Mark items read as you go.',
      },
      {
        label: 'Events',
        description:
  ...
  adviser: {
    ...
    overview:
      'Your adviser account is ready. You oversee the research projects assigned to you: track progress, move projects through research stages, review paper versions, book meetings with students, and monitor defense schedules. The dashboard surfaces pending paper reviews and recent advisee activity so you can respond quickly. You can also join projects with a project code when invited or accept pending invitations from student leaders.',
    keyTasks: [
      ...
      'Stay current on review requests, invitations, and schedule changes via notifications',
    ],
    capabilities: [
      {
        label: 'Dashboard',
      ...
      },
      {
        label: 'My Advisees',
        description:
          'All projects you advise, with search and filters by course and program. Open any project to manage stage, team, meetings, and paper versions. Accept pending invitations here.',
      },
      {
        label: 'Notifications',
        description:
          'Alerts for review requests, invitations, meeting updates, defense schedules, and other advisee activity. Review-request notifications link directly to the paper versions section.',
      },
      {
        label: 'Events',
        description:
    ...
    workflows: [
      {
        title: 'Review a student paper',
        steps: [
          'Check Pending Reviews on your dashboard or open the notification for a review request.',
          'Open the project and expand Paper Version History to read the requested version.',
          'Read the student\'s focus note to understand what feedback they need.',
          'Download the file or use document preview to compare changes from the previous version.',
          'When finished, choose Mark reviewed on the pending request.',
        ],
      },
      {
