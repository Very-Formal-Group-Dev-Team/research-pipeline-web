...
const authActionButtonClassName =
  'w-full h-12 flex items-center justify-center px-6 font-medium rounded-[3px] transition-all duration-200';
...
function GoogleSignInButton() {
    ...
    return (
      <button
        ...
        className={`${authActionButtonClassName} gap-3 bg-white border-2 border-neutral-900 text-neutral-800 shadow-sm hover:bg-neutral-50 hover:border-neutral-900 active:bg-neutral-100 group`}
